...
**scipy** — the core of the allocation engine. Specifically scipy.optimize.linear_sum_assignment which implements the Hungarian algorithm — this is the mathematical solver that finds the globally optimal student-project assignment. This is equivalent of glpsol (GLPK).
